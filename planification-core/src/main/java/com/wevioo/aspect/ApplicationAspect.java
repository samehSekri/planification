...
/**
 * Configuration des log pour toute méthode ayant l'annotation AspectLogging.
 * 
...
public class ApplicationAspect {
	 ...
	 * @param joinPoint
	 */
	@Before("execution(* com.wevioo.utility.*.*(..)) && @annotation(com.wevioo.annotation.AspectLogging)")
	 ...
	 * @param result
	 */
	@AfterReturning(pointcut = "@annotation(com.wevioo.annotation.AspectLogging)", returning = "result")
	 ...
	 * @param error
	 */
	@AfterThrowing(pointcut = "@annotation(com.wevioo.annotation.AspectLogging)", throwing = "error")
