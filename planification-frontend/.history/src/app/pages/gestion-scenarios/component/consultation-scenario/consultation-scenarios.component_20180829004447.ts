...
export class ConsulationScenarioComponent implements OnInit {
  ...
  let   filterScenario=new FilterScenario(null,null,null);
    filterScenario.statut = this.statutScenario;
    filterScenario.unite = this.currentUnite;
    filterScenario.dateCreation = null;
