...
import { FilterScenario } from '../../../../shared/model/filterScenario.model';
...
export class ConsulationScenarioComponent implements OnInit {
  ...
  public scenario: any;
  public filterScenario: FilterScenario;
  public msgs: Message[] = [];
  status = [
    { name: "BROUILLON" },
    { name: "NON_VALIDE" },
  ...
  public getAllScenarios(): void {
    this.filterScenario.statut = this.statutScenario;
    this.filterScenario.unite = this.currentUnite;
    this.filterScenario.dateCreation = null;

    this.scenarioService.getByCriteria(this.filterScenario).subscribe((data: Scenario[]) => {
      this.scenarios = data;
