...
public class RestAspect {
	...
	private final String PACKAGE_TO_LOG_IN = "com.wevioo.controller";
	 ...
	 * @param joinPoint
	 */
	@Before("execution(* " + PACKAGE_TO_LOG_IN + ".*.*(..)) && @annotation(org.springframework.web.bind.annotation.RequestMapping)")
	 ...
	 * @param result
	 */
	@AfterReturning(pointcut = "execution(* " + PACKAGE_TO_LOG_IN
