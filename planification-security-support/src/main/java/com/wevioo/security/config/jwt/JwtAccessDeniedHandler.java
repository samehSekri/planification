...
// The handler will catch the exception generated by the hhtp status response and headers and then 
// we map it to ApiException and we return a json response from it .
@Component
